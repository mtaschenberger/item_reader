...
@retry.retry(tries=3)
def process_item(image_path: str, vault_root: str = "./vault", port: int = 11434) -> None:
...
# recusivly read list all image files from a folder ai!
...
if __name__ == "__main__":
    ...
    folder = sys.argv[1:]
    " AI! create a list of files by recursibly reading all png and jpg files from the folder"
